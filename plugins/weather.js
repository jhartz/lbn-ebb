...
ebb.plugins.push({
    ...
    content: [
        ...
        '<tr><td><div class="squished" style="max-height: 290px;"><img class="img PLUGIN_weather_hourly_img1"><br><span class="PLUGIN_weather_hourly_status1">DNE</span></div></td><td><div class="squished" style="max-height: 290px;"><img class="img PLUGIN_weather_hourly_img2"><br><span class="PLUGIN_weather_hourly_status2">DNE</span></div></td><td><div class="squished" style="max-height: 290px;"><img class="img PLUGIN_weather_hourly_img3"><br><span class="PLUGIN_weather_hourly_status3">DNE</span></div></td></tr>' +
        ...
        '<tr><td><div class="squished" style="max-height: 340px;"><img class="img PLUGIN_weather_forecast_img1"><br><span class="PLUGIN_weather_forecast_status1">DNE</span></div></td><td><div class="squished" style="max-height: 340px;"><img class="img PLUGIN_weather_forecast_img2"><br><span class="PLUGIN_weather_forecast_status2">DNE</span></div></td><td><div class="squished" style="max-height: 340px;"><img class="img PLUGIN_weather_forecast_img3"><br><span class="PLUGIN_weather_forecast_status3">DNE</span></div></td></tr>' +
