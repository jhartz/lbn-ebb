...
ebb.input = {
    // If this is true, then the "Load Options from LEO File" button is visible and the associated "more info" button that tells the user about the LBN EBB Optionifier
    LEO_INPUT_ENABLED: true,
    ...
    load: function () {
        ...
        if (ebb.input.LEO_INPUT_ENABLED && typeof FileReader != "undefined" && typeof document.getElementById("input_load_file_input").click == "function") {
